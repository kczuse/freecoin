...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    GenerateFreecoins(fGenerate, pwalletMain);
    return Value::null;
}
...
Value getmininginfo(const Array& params, bool fHelp)
{
    ...
    //{
        ...
        //GetProofOfWorkReward(nBits,pIndex0->nHeight, MIN_TX_FEE, pIndex0->pprev->GetBlockHash()) / 3;
